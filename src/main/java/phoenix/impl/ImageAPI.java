...
public class ImageAPI {
     ...
     * @param tag       imae tag (ie, image group, poster, poster_small, background,
     ...
     * image.
     *
     * @param image  String file/url, or File, or Sage File or BufferedImage
     * @param width  scaled width; -1 means proportional
     * @param height scaled height; -1 means proportional
     * @return
     ...
     *
     * @param imageId      image id or fake image name (ie, "somimage.jpg")
     * @param imgWidth
     * @param imgHeight
     * @param opacityStart
     * @param opacityEnd
