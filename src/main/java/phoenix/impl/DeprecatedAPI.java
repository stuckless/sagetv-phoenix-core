...
public class DeprecatedAPI {
     ...
     *
     * @param provider   provider to use for scanning, or null, to use the default
     *                   metadata provider
     * @param mediaFiles Object Array of Sage MediaFile or Airing objects
     ...
     *
     * @param provider  metadata provider or null for the default
     * @param mediaFile mediafile or mediafile title
     * @return metadata
     ...
     *
     * @param type "A" for all, "S" for core sage, "E" for extended
     * @return
     * @deprecated configure using web ui, or using Configuration Metadata
     */
