...
public class MediaMetadataAPI {
     ...
     *
     * @param mediaFiles Object Array of Sage MediaFile or Airing objects, or a File
     *                   object specifying a directory
     ...
     *
     * @param progress ProgressTracker from a StartMetadataScan operation
     ...
     * completed.
     *
     * @param tracker Progress Tracker from a StartMetadataScan operation
     ...
     *
     * @param mediaFile mediafile or title
     ...
     *
     * @param result metadata search result
     * @return title
     */
     ...
     *
     * @param mediaFile SageTV media file object
     * @param result    metadata search result
     * @param wait      if false, then it will run in the background
     */
     ...
     * <br/>
     * The valid options are overwrite-fanart, overwrite-metadata. All options
     * must be set as a string such as "true" or "false"
     *
     * @param mediaFile SageTV media file object
     * @param result    metadata search result
     * @param wait      if false, then it will run in the background
    ...
    /**
     * Return the number of failed items in this progress. You can call this
    ...
    /**
     * Return the number of success items in this progress. You can call this
     * while a scan is in progress.
     *
     * @param progress
     * @return
    ...
    /**
     * Return the number of skipped items in this progress. You can call this
     * while a scan is in progress.
     *
     * @param progress
     * @return
    ...
    /**
     * return the {@link IMediaFile} that failed in this progress, use the
     * {@link MediaBrowserAPI} to access this object
     *
     * @param progress
     * @return
     */
    ...
    /**
     * return the {@link IMediaFile} that succeeded in this progress, use the
     * {@link MediaBrowserAPI} to access this object
     *
     * @param progress
     * @return
    ...
    /**
     * return the {@link IMediaFile} that skipped in this progress, use the
     * {@link MediaBrowserAPI} to access this object
     *
     * @param progress
     * @return
    ...
    /**
     * Return a list of all the known Trackers that are in the system. Some may
     * have been completed.
     *
     * @return
     */
    ...
    /**
     * Creates a base set of 'hints' or options that can be passed to a scan.
     * For a complete list of the hint keys, see the {@link MetadataHints}
     * static constants
     *
    ...
    public boolean UpdateMetadata(Object mediafile, IMetadata metadata, Object hints) {
        try {
            Phoenix.getInstance().getMetadataManager()
                    .updateMetadata(phoenix.media.GetMediaFile(mediafile), metadata, getHints(hints));
    ...
    /**
     * Sets the provider id and the provider's unique id, ie, the imdb id, or
     * the tvdb id in the search. This is used to search based on the known id
     * for an item.
     *
     * @param q
     * @param provider
