...
public class MediaBrowserAPI {
	 ...
	 * 
	 * @param folder
	 *            ViewFolder or IMediaFolder instance
	 * 
...
{alt}F4 = Exit/Close Program
	 ...
	 * 
	 * @param view
	 *            {@link Factory} id of the {@link IMediaFolder} view factory
	 * @param options
	 *            either a Map of name value pairs or a string in json map
	 ...
	 * 
	 * @param media
	 *            resource (file, folder, sage object)
	 * @return
	 */
	 ...
	 *            if true then ALL tags are returns, if false then ONLY VISIBLE
	 *            tags are returned
	 * 
	 * @return
	 */
