...
public class DynamicMenusAPI {
	 ...
	 * 
	 * @param parent
	 *            if this is a submenu, then this should be the parent for the
	 *            menu
	 * @param name
	 ...
	 * 
	 * @param parent
	 *            menu to which the item will be added
	 * @param name
	 *            unique menu item id/name
	 * @param label
	 *            display label
	 * @return
	 */
	 ...
	 * @param item
	 * @param parentMenuId
	 *            id of the menu in which to insert this new item (cannot be
	 *            null)
	 * @param insertBefore
	 *            id of the element to insert before (can be null)
	 * @param insertAfter
	 *            id of the elements to insert after (can be null)
	 ...
	 * @param os
	 *            one of windows, linux, mac, or null for all
	 * @param workingDir
	 *            complete path to a working directory
	 * @param outputVariable
	 *            StaticGlobal where the output will be stored (can be null)
	 * @return
	 */
