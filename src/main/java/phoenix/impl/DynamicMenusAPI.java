...
public class DynamicMenusAPI {
    ...
    /**
     * This sets/removes a hidden flag to menu's UserRecord, to indicate that the user is hiding the menu/item.
     * 
    ...
    /**
     * Get the Secondary Icon for the given MenuItem as a {@link DynamicVariable}
     * @param item MenuItem
     * @return icon
     */
    ...
    /**
     * For a given menu item or menu, return the help text / description associated with the item.
     * 
    ...
    /**
     * For a given menu item or menu, return the help text / description associated with the item as a {@link DynamicVariable}.
     * 
     * @param menu MenuItem or Menu object
     * @return help text for the menu or menu item
     */
    ...
    /**
     * Get the Background for the given Menu/MenuItem as a {@link DynamicVariable}
     * 
     * @param item Menu/MenuItem
     * @return icon
     */
    ...
    /**
     * Get the Field Value for the given Menu/MenuItem as a {@link DynamicVariable}
     * 
     * @param item Menu/MenuItem
     * @param fieldName field name
     * @return Field Value
    ...
    /**
     * Return True if the Object being pass is a Menu.  This is used when iterating over menu items
     * to determine if a given menu item has children.
     * 
     * @param menu
     * @return
     */
    ...
    /**
     * Returns the Linked Menu for this menu/menuItem or null, if there is no linked menu.
     * 
    ...
    public Menu GetLinkedMenu(IMenuItem item) {
    	try {
	        if (item==null || item.linkedMenuId().get()==null) return null;
    ...
    /**
     * Returns the Linked Menu ID for this menu/menuItem as a {@link DynamicVariable}.
     * 
     * @param item {@link IMenuItem} or {@link Menu}
     * @return {@link Menu} or null
     */
    ...
    /**
     * Return the unique id or name for this menu.  A menu name is not required, but if it does have a name, then
     * it must be unique for ALL menus and items within the entire menu system. 
     * 
     * @param item {@link IMenuItem} or {@link Menu}
     * @return {@link Menu} or null
     */
    ...
    /**
     * Creates a NEW menu with the given name.  The name should be a unique identifier for the menu.
     * 
     * @param parent if this is a submenu, then this should be the parent for the menu
    ...
    /**
     * Saves the given {@link IMenuItem} (which can be a {@link Menu} or {@link MenuItem} since the both implement {@link IMenuItem}
     * to the userdata menus areas.  The filename will be combination of the parent menu, and the item ids combined.
     * 
     * @param item
     * @param parentMenuId id of the menu in which to insert this new item (cannot be null)
    ...
    /**
     * Gets the Screen for a {@link SageScreenAction} as a {@link DynamicVariable}
     * 
     * @param a
     * @param value
     */
    ...
    /**
     * Returns the command/action for a {@link SageCommandAction} as a {@link DynamicVariable}
     * @param a
     * @return
     */
    ...
    /**
     * Returns the Sage Expression for the {@link SageEvalAction} as a {@link DynamicVariable}
     * 
     * @param a
     * @return
     */
    ...
    /**
     * Adds a {@link SageEvalAction} to a menu item.  A sage eval action allows you to execute
     * a sage expression
     * 
     * @param item
     * @param screenName
     ...
     * @return
     */
    public ExecuteCommandAction AddExecuteCommandAction(IMenuItem item, String exe, String args, String os, String workingDir, String outputVariable) {
    ...
    /**
     * Returns the Computed Value for a given Variable.  ie, if the Variable is set a Property, then 
     * this returns the value of that property (ie, computed value)
     * 
    ...
    /**
     * Returns the value that was used to set the Dynamic Variable.  ie, if the dynamic variable is a 
     * property dynamic value, then this call returns the property name as the value.
     * 
     * @param var {@link DynamicVariable}
     * @return the value stored in this {@link DynamicVariable} (not the computed value)
     */
    ...
    /**
     * Updates the value of the {@link DynamicVariable}.  Use this method to update the value, so that if you set a property,
     * expression, or static value, then the dynamic variable can adjust correctly.
     * 
     * See {@link DynamicVariable}.setvalue() for information on what types expressions that you can set
     * 
     * @param var
     * @param value
     */
    ...
    /**
     * Inserts the Menu Item before the reference item.  If the itemToInsert already
     * exists, then it is removed, and then re-added at the location before the reference item.
     * 
     * @param menu
     * @param itemToInsert
     * @param referenceItem
    ...
    /**
     * Inserts the Menu Item After the reference item.  If the itemToInsert already
     * exists, then it is removed, and then re-added at the location after the reference item.
     * 
     * @param menu
     * @param itemToInsert
     * @param referenceItem
    ...
    /**
     * Inserts the Menu Item Action before the reference {@link Action}.  
     * If the itemToInsert already
     * exists, then it is removed, and then re-added at the location before the reference item.
     * 
     * @param menuitem
    ...
    /**
     * Re-applies the Sort criteria to the menu items for this menu, if there is a sort criteria defined.
     * 
     * @param menu
     */
    public void SortItems(Menu menu) {
    	if (menu!=null) menu.sortItems();
    }
    
    /**
     * Saves the current sort order for the menu items of this menu. The sort order is persisted, and when the
     * menu is re-loaded the items current sort order will be remembered.
     * 
     * @param menu
     */
    public void SaveSortOrder(Menu menu) {
    	if (menu!=null)	menu.saveOrder();
    }
