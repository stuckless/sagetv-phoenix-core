...
public class FanartAPI {
	/**
	 * Store for the tv series fanart defaults
	 * {@value}
	 */
	public static final String STORE_SERIES_FANART = "phoenix.seriesfanart";
	/**
	 * Store the tv season fanart defaults
	 * {@value}
	 */
	 ...
	 * 
	 * @param mediaObject
	 *            - SageTV MediaFile, Airing, or Show object
	 ...
	 * 
	 * @param mediaObject
	 *            SageTV MediaFile, Airing, or Show
	 ...
	 * @param genre
	 * @param artifactType
	 *            String value of "banner", "background", "poster"
	 * @return
	 */
	 ...
	 * 
	 * @param value
	 *            true if you to set Fanart Enabled, or false to disable Fanart
	 */
	 ...
	 * 
	 * @param folder
	 *            Set a new location for the Central Fanart Folder
	 */
	 ...
	 * 
	 * @param mediaObject
	 *            media object on which the default fanart is being set
	 * @param fanart
	 *            File or String path that must exist, and it must be a file in
	 ...
	 *            media object
	 * @param create
	 *            if true, then create the dir if it does not exist.
	 * @return folder path
	 */
	 ...
	 * 
	 * @param mediaObject
	 *            Sage MediaFile/Airing object (can be null, if you are asking
	 *            for Genres or Actors)
	 * @param mediaType
	 *            one of tv, movie, music, actor, genre
	 * @param mediaTitle
	 *            media tile (or genre title if mediaType is genre, or actor
	 *            name if mediaType is actor)
	 * @param artifactType
	 *            one of poster, background, banner
	 * @param artifactTitle
	 *            this is normally always null, but if it's not, then it will
	 *            basically become a child sub directory in the fanart path
	 * @param metadata
	 *            any extra metadata, such as SeasonNumber if you doing season
	 *            specific fanart
	 * @return
	 */
	...
	private String GetFanartArtifact(Object mediaObject, MediaType mediaType, String mediaTitle, MediaArtifactType artifactType,
		...
		if (fa == null) {
			...
			File def = GetDefaultArtifact(mediaObject, mediaType, mediaTitle, artifactType,
					artifactTitle, metadata);
			if (def != null) {
	 ...
	 * 
	 * @param mediaObject
	 *            Sage MediaFile or Series Title
