...
/**
 * Remote API is a helper API class for helping Remote devices (Web, Android, iOS, etc).  The APIs included here are
 * basically "convenience" apis to make the communication with the remote device easier.
 * 
 * @author sls
 *
 */
...
public class RemoteAPI {
	/**
	 * Since you cannot delete a system message by ID, this is a convenience method for finding and then
	 * deleting a system message by name and time.  This is mainly used by remote systems, such as web ui, or
	 * android for deleting messages.
	 * 
	 * @param message
	 * @param startTime
	 * @param endTime
	...
	/**
	 * Returns the System Messages as a List containing a Map of elements that represent the System Message.  This
	 * is meant as a convenience method that creates a structure that can easily be serialized for json transport.
	 * @return
	 */
	...
	/**
	 * Searches a given view for a title containing the passed title string.  If TV files are used, then 
	 * both the TITLE adn the EPISODENAME is searched.
	 * 
	 * @param titleContains
	 * @param baseViewName
	 * @return
	...
	/**
	 * Searches a given view for all media files that contain the given "actor" criteria.
	 * 
	 * @param actorContains
	 * @param baseViewName
	 * @return
