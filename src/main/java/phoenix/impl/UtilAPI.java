...
public class UtilAPI {
	 ...
	 *            Array or List
	 * @param start
	 *            0 based starting element
	 * @param length
	 *            # of elements to return (or -1 for all remaining elements)
	 * @return
	 */
	@SuppressWarnings("unchecked")
	 ...
	 * 
	 * @param quick
	 *            Just perform a quick check, usually takes less than a second.
	 ...
	 * 
	 * @param sources
	 *            A single File, or an Array of File objects in which the
	 *            mediaFile may reside.
	 * @param mediaFile
	 *            A String path, or File Object, or Sage MediaFile object from
	 *            which to get a path.
	 ...
	 * 
	 * @param o
	 *            Object that needs to be converted to a String
	 ...
	 * 
	 * @param options
	 *            a Map<String,String> or a json string
