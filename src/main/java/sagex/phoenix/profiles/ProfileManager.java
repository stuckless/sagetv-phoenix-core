...
public class ProfileManager {
    ...
    /**
     * The current profile is associated with the current user for any given client.  The same user client can be
     * connected to multiple clients, but a single client can only be connected to a single client.
     * 
     * If no profile has been assigned to a given client, then a "default" profile is created and used.
     * 
     * @return
     */
