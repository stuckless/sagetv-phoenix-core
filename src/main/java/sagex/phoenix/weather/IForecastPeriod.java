...
/**
 * Interface to access the Forecast data for a Period of a day or the Current Weather
 * A Period is typically a Day or a Night where a day will have 2 periods
 * A period could be the Current Period or Current Weather
 * note: not all fields will be populated depending on the implementation
 *  - non-implemented string fields should return null
 *  - non-implemented integer fields should return 
 * 
 * @author jusjoken
 */
...
public interface IForecastPeriod {
     ...
     * 
     */
    public static enum Type {Day, Night, Current}
    ...
    /**
     * Returns a short descriptive text for this specific forecast period. It will be
     ...
     * </pre>
     * 
     * May vary by implementation but should be a code between 0 and 47
     * Should be -1 if not available
    ...
    /**
     * Return the Formatted precipitation for the forecast period
     * - can be in either inches, mm, or may be % so should be fully formatted for display
     * 
    ...
    /**
     * Return the humidity for the forecast Period
    ...
    /**
     * Returns the wind speed for the forecast period.
     * - should be 0 for CALM
     * - should be -1 if invalid or unavailable
     * 
     * @return wind speed
     */
