...
/**
 * WorldWeather Online implementation for Phoenix
 * API Key to access our weather forecast is p6y5b5g5haupghedu7p42nbb
 * **** OLD API Key to access our weather forecast is b18c521658003002121007 - not used after 8/31/2013
 * 
 * www.worldweatheronline.com
 * The base URL for the Free Local Weather API is 
 *  http://api.worldweatheronline.com/free/v1/weather.ashx
 *  **** OLD url http://free.worldweatheronline.com/feed/weather.ashx
 *
 * @author jusjoken
 */
public class WorldWeatherWeatherSupport implements IWeatherSupport2 {
    ...
    public boolean update() {
        if (shouldUpdate()) {
            ...
            //Changed the url string below as World Weather changed their API as of March 2013 and old API will be off line as of Aug 31st 2013
            //String rssUrl = "http://free.worldweatheronline.com/feed/weather.ashx?q=" + thislocation + "&format=xml&num_of_days=5&includeLocation=yes&extra=localObsTime&key=b18c521658003002121007";
            String rssUrl = "http://api.worldweatheronline.com/free/v1/weather.ashx?q=" + thislocation + "&format=xml&num_of_days=5&includeLocation=yes&extra=localObsTime&key=p6y5b5g5haupghedu7p42nbb";
