...
public class WorldWeatherWeatherHandler extends BaseBuilder {
    private enum State {Current, LongRange}
    ...
    public void startElement(String uri, String localName, String name, Attributes attr) {
        //log.info("startElement: string '" + string + "' string1 '" + string1 + "' elName '" + elName + "' atrbts '" + attr + "'");
    ...
    public void endElement(String uri, String localName, String name) {
        //log.info("endElement: uri '" + uri + "' string1 '" + localName + "' string2 '" + name + "'");
        ...
        if ("areaName".equals(name)) {
            ...
            currentLongRange.getForecastPeriodNight().setCode(phoenix.weather2.GetCodeForceNight(convertCode(NumberUtils.toInt(getData(),IForecastPeriod.iInvalid))));
    ...
    private int formatVisibility(String wwVis){
        ...
        if (vis==IForecastPeriod.iInvalid) return IForecastPeriod.iInvalid;
