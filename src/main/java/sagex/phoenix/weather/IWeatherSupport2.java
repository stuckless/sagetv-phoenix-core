...
public interface IWeatherSupport2 {
    ...
    /**
     * Returns the location code used by the weather source.
     * typically a zip code, postal code or special location code
     * 
    ...
    /**
     * Returns the location name used by the weather source.
     * typically a City Name
     * 
     * @return specific location code
     */
    ...
    /**
     * Returns the CurrentWeather retrieved from the last update.
     * the implementation should ensure an update is called prior to this.
     * 
    ...
    /**
     * Returns a list of all available days of Long Range Forecasts.
     * the implementation should ensure an update is called prior to this.
     * 
    ...
    /**
     * Returns the {@link Date} this source was last refreshed
     * this is the date phoenix requested an update to the weather data
     * 
    ...
    /**
     * Returns the {@link Date} the weather data was recorded by the source
     * this is the date the source API returns if available
     * 
    ...
    /**
     * Returns if any error has occurred updating or changing settings of the weather source
     * 
