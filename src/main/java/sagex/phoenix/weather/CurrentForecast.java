...
public class CurrentForecast extends ForecastPeriod implements ICurrentForecast, Serializable {
	...
	public String toString() {
		return "CurrentForecast ["
                                ...
                                + " code=" + this.getCode()
                                + " precip=" + this.getPrecip()
                                + " humid=" + this.getHumid()
                                + " windspeed=" + this.getWindSpeed()
                                + " winddir=" + this.getWindDir()
                                + " winddirtext=" + this.getWindDirText()
                                + " description=" + this.getDescription()
                                + " [cloudCover=" + cloudCover + ", date=" + date
				+ ", dewPoint=" + dewPoint + ", feelsLike=" + feelsLike
				+ ", pressure=" + pressure + ", pressureDir=" + pressureDir
				+ ", sunrise=" + sunrise + ", sunset=" + sunset + ", UVIndex="
				+ UVIndex + ", UVWarn=" + UVWarn + ", visibility=" + visibility
				+ "]";
	}
