...
public class FanartUtil {
	 ...
	 * 
	 * @param mediaType
	 *            {@link MediaType} (TV, Movie, etc)
	 * @param mediaTitle
	 *            fanart title identifier (it will be cleaned)
	 * @param artifactType
	 *            {@link MediaArtifactType} Fanart Artifact Type (Banner,
	 *            Background, etc)
	 * @param artifactTitle
	 *            artifact title, usually used with Actor artifact type to
	 *            provide the actor name
	 * @param centralFolder
	 *            Central Folder Location
	 * @param metadata
	 *            any extra metadata about the object, ie, SeasonNumber, etc.
	 ...
	 *            Background, etc)
	 * @param artifactTitle
	 *            artifact title (usually only used with actor name for actor
	 *            fanart)
	 * @param centralFolder
	 *            Central Folder Location
	 * 
