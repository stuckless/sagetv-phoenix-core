...
/**
 * FanartSupport class that falls back on the legacy sagemc when fanart
 * cannot be located in the new system.
 * 
 * @author seans
 *
 */
...
public class PhoenixWithLegacySageMCSupport implements IFanartSupport {
    ...
    public File GetFanartArtifact(Object mediaObject, MediaType mediaType, String mediaTitle, MediaArtifactType artifactType, String artifactTitle, Map<String, String> metadata) {
