...
public class Skin implements ISkin {
    public enum State {FAILED, UNINSTALLED, INSTALLED, RESOLVED, STOPPING, STARTING, ACTIVE}
    ...
    /* (non-Javadoc)
	 * @see sagex.phoenix.skins.ISkin#setManager(sagex.phoenix.skins.SkinManager)
	 */
    /* (non-Javadoc)
	 * @see sagex.phoenix.skins.ISkin#setManager(sagex.phoenix.skins.SkinManager)
	 */
