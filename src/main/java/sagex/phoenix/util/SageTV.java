...
public class SageTV {
     ...
     * 
     * if GetUIContextNames returns 1 item, then use it
     * if it returns more than 1, then determine which one to use by
     * 
     * Parse the current execution thread for the context name.  Threads with a contextname will look like this....
     * ActiveRender-001d098ac46c
     * 
     * 
     * @return
     */
