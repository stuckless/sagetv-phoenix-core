...
public class DOMUtils {
    ...
    /**
     * Returns a parsed document for the url. if the IUrl instance is a CachedUrl, then and there
     * is a parsing error, then the the cached url will be removed, and it will be tried again.
     * 
     * @param url
     * @return
     * @throws Exception 
	...
	public static Document parseDocument(IUrl url) throws Exception {
		...
		try {
			...
			try {
				...
				Loggers.LOG.warn("Failed to parse url " + url + " because of " + e.getMessage() + "; will try to use a gzip decoder on it");
