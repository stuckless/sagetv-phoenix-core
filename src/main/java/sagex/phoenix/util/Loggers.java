...
/**
 * Loggers returns an instances of special loggers that can be used in additional the
 * normal log4j logging.  For example, you may need, in some cases, an instance of a
 * vfs debug logger that can be tweaked differently than a normal class logger.
 * 
 * typically when you get an instance of these loggers, for debugging, you should always
 * check logger.isDebugLogEnabled() before do any debug logging, since you are probably
 * logging very expensive operations.
 * 
 * @author seans
 *
 */
public class Loggers {
     ...
     * 
     * This is general purpose logger used mostly by util classes that don't want to
     * keep a reference to their own logger
     */
