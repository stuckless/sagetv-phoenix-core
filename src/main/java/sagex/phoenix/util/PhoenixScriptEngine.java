...
/**
 * Creates a scripting engine that is capable of executing scripts (ie, javascript, python, groovy, etc)
 * while allowing access to Phoenix and the SageTV apis.
 * 
 * @author seans
 *
 */
public class PhoenixScriptEngine {
    ...
    /**
     * Creates a Phoenix Scripting Engine that gets an engine based on the extension of the file.
     * ie, a file.js would return a JavaScript engine; file.groovy would return a Groovy engine, etc.
     * The contents of the file is NOT added to the script engine.  You still need
     * to call addScript() to add a script to the script engine.
     * @param file
     */
    ...
    /**
     * Initializes the engine using a file (ie, the script type of the file).  The
     * contents of the file is NOT added to the ScriptEngine.  This just initializes
     * the engine type based on the file type
     * 
     * @param file
     */
    ...
    /**
     * Creates a Phoenix Scripting Engine that gets an engine based on the specified named
     * scripting engine, ie, "JavaScript", "Python", etc.
     * @param scriptType
     */
