...
/**
 * Base Xml Parser that handles errors, etc.  Xml parsers should extend this parser, to get better error logging.
 *  
 * @author seans
 *
 */
public class BaseBuilder extends DefaultHandler {
    ...
    // TODO: Change this when we go to production, or use a configuration property for xml validation
    ...
    /**
     * @param name - used for logging and error reporting
     */
    ...
    public void error(SAXParseException saxparseexception) throws SAXException {
        ...
        if (locator!=null) {
            log.warn(String.format("Xml Parser Failure at line %d, column: %d; for: %s", locator.getLineNumber(), locator.getColumnNumber(), name), saxparseexception);
        } else {
        ...
        if (failOnError) throw saxparseexception;
    }
    ...
    public void fatalError(SAXParseException saxparseexception) throws SAXException {
        ...
        if (locator!=null) {
            log.warn(String.format("Fatal Xml Parser Failure at line %d, column: %d; for: %s", locator.getLineNumber(), locator.getColumnNumber(), name), saxparseexception);
        } else {
    ...
    public void warning(SAXParseException saxparseexception) throws SAXException {
        ...
        if (locator!=null) {
            log.warn(String.format("Xml Parser warning at line %d, column: %d; for: %s", locator.getLineNumber(), locator.getColumnNumber(), name), saxparseexception);
        } else {
