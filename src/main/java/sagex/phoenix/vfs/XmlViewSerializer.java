...
public class XmlViewSerializer {
	public void serialize(ViewFactory factory, OutputStream os) throws IOException {
		...
		doc.setDocType(DocumentFactory.getInstance().createDocType("vfs", null, "vfs.dtd"));
	...
	private void serializeOptions(BaseConfigurable options, Element optionsParent) {
