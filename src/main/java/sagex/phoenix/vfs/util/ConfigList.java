...
public class ConfigList {
	...
	public static ConfigurableOption BooleanOption(String optName, String label, boolean defValue) {
		return new ConfigurableOption(optName, label, String.valueOf(defValue), DataType.bool, true, ListSelection.single, BOOLEAN_LIST);
	}
	
	/**
	 * Builds a list for a {@link ConfigurableOption}.  Input must be "key:Label,key1:Label1,..."
	 * 
	 * @param list
	 * @return
	 */
