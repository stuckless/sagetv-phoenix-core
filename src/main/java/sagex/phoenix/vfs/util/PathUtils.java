...
/**
 * PathUtils work with Resources as inputs, but it will use the underlying File object for all operations.
 * 
 * @author seans
 *
 */
public class PathUtils {
    ...
    /**
     * Return the Name of the resource.  If the resouce has a filesystem File object, then it will return the name of that File, otherwise
     * it will return the Title of the given resource.
     * 
     * @param res
     * @return
     */
    ...
    /**
     * Returns the Path for the given resource.  If the resouce has a fileystem File object, then the path of that File is returned,
     * otherwise, it will build up a virtual path as a unix style path, of the given resource and its parent resources.
     * 
     * @param res
     * @return
     */
