...
/**
 * Base filter that accepts a regular expression as the filter value.  A base class can simply
 * call match(String in) to determine a match.
 * 
 * @author seans
 */
public abstract class BaseRegexFilter extends Filter {
	/**
	 * regular expression variable name
	 * {@value}
	 */
