...
/**
 * Filters media based on the Types listed in the {@link MediaResourceType} class
 * 
 * the value can either be number of a string, ie, "1" or "FILE", or "file", or "File".
 * 
 * @author seans
 *
 */
public class MediaTypeFilter extends Filter {
    ...
    public MediaTypeFilter() {
    	super();
    	addOption(new ConfigurableOption(OPT_VALUE, "Media Type", null, DataType.string, true, ListSelection.single, ConfigList.mediaTypeList()));
    }
