...
/**
 * A filter for files that the user has started to watch, but has not finished.
 * 
 * @author skiingwiz
 */
public class PartiallyWatchedFilter extends Filter {
	public PartiallyWatchedFilter() {
		super();
		addOption(new ConfigurableOption(OPT_VALUE, "Partially Watched", "true", DataType.string, true, ListSelection.single,
				"true:Yes,false:No"));
	}
