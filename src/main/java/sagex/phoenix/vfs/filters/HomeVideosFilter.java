...
/**
 * Returns true if the file is a considered to be a Home Video. ie the file's path is in a configured
 * Home Video folder.
 * 
 * @author sean
 */
public class HomeVideosFilter extends Filter {
    ...
    public boolean canAccept(IMediaResource res) {
    	...
    	if (StringUtils.isEmpty(dirspec)) return false;
    ...
    public static boolean isHomeVideo(IMediaResource res) {
    	if (filter==null) filter=new HomeVideosFilter();
