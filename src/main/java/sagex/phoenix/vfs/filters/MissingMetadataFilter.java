...
/**
 * Filter returns true if the {@link IMediaFile} is missing core metadata fields.  This only
 * applies to TV and Video files, and for TV, it means season/episode information
 * 
 * @author seans
 */
