...
/**
 * A filter for files that were watch within the last 
 * configurable interval (one day, by default)
 * 
 * @author skiingwiz
 *
 */
public class RecentlyWatchedFilter extends Filter {
	...
	public RecentlyWatchedFilter() {
    	super();
    	addOption(new ConfigurableOption(OPT_VALUE, "Recently Watched", "true", DataType.string, true, ListSelection.single, "true:Yes,false:No"));
