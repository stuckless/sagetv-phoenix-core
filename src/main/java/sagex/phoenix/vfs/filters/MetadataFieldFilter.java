...
public class MetadataFieldFilter extends Filter {
	...
	public MetadataFieldFilter() {
		...
		addOption(new ConfigurableOption(OPT_VALUE, "Field Value", null, DataType.string, true, ListSelection.single,
				ConfigList.metadataList()));
		addOption(new ConfigurableOption(OPT_COMPARE_AS_NUMBER, "Compare as Numbers", "false", DataType.bool, true,
