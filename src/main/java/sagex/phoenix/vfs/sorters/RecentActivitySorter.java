...
/**
 * Sorts based on the Start Date/Time, but when comparing a folder to an item we will
 * figure out what the most recent activity in the folder was do the comparison
 * 
 * @author bialio
 *
 */
