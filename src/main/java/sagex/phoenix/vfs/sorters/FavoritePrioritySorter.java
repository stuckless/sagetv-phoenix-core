...
/**
 * Sorts based on favorite priority
 * non-favorites are unsorted at the bottom of this sort
 * 
 * @author bialio
 *
 */
public class FavoritePrioritySorter implements Comparator<IMediaResource>, Serializable {
    ...
    private int getFavoritePriority(IMediaResource o) {
    	...
    	if (o instanceof IMediaFolder) {
    		...
    		// this assumes that all members of the folder are the same 'Favorite'
