...
/**
 * Sorts based on the value of "GetWatchedStartTime()", but when comparing a folder to an item we will
 * figure out what the most recently watched date in the folder was do the comparison
 * 
 * @author bialio
 *
 */
