...
public class TitleSorter implements Comparator<IMediaResource>, Serializable, HasOptions {
    ...
    public TitleSorter() {
        options.add(new ConfigurableOption("ignore-the", "Disregard 'the' when sorting", "false", DataType.bool, true, ListSelection.single, "true:Yes,no:No"));
        options.add(new ConfigurableOption("ignore-all", "Disregard 'a', 'an', and 'the' when sorting", "false", DataType.bool, true, ListSelection.single, "true:Yes,no:No"));
    }
    ...
    /**
     * Takes a string and returns the same string with  "The ", "An ", and "A " removed from the beginning of it.
     * @param in 	input String.
     * @param all 	if false, just 'The ' is removed.  Otherwise The, An, or A is removed.
     * @return
     */
