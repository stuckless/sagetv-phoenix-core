...
/**
 * Groups based on the parent's groupName and a regular expression.  ie, you can use this to group
 * based on the first character of the title by passing a regular expression of '.'.
 *  
 * @author sean
 */
