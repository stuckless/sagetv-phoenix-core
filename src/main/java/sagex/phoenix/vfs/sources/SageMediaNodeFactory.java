...
public class SageMediaNodeFactory extends Factory<IMediaFolder> {
	public SageMediaNodeFactory() {
		super();
		addOption(new ConfigurableOption(
				"content",
				"Content",
				null,
				DataType.string,
				...
				"Filesystem:File System,VideoNavigator:Videos,MusicNavigator:Music,MusicVideosNavigator:Music Videos,MoviesNavigator:Movies,TVNavigator:TV,VideosByFolder:Videos by Folder"));
		addOption(new ConfigurableOption("grouping", "Grouped By", null, DataType.string, true, ListSelection.single,
				"Folder,Genre,Year,Album,Director,Actor,Studio,Title,Series,Artist,Channel"));
