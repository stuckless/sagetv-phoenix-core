 ...
 * it uses that Folder for all sources.
 * 
 * This is mainly used for testing, but can also be used programatically. It
 * will never be available from the xml, since it requires a pre-built
 * MediaFolder as its source.
 * 
 * @author seans
 */
