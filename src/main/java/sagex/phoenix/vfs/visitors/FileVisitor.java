...
/**
 * Convenience Base class for creating File visitors. It tracks the number of
 * files visisted and you can track the number of files affected by calling
 * incrementAffected from your visitFile method. you also don't needt test if
 * it's a file, since that check will be done for you as well.
 * 
 * @author seans
 */
