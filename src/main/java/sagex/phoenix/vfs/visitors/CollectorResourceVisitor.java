...
public class CollectorResourceVisitor implements IMediaResourceVisitor {
    ...
    /**
     * Creates collector that will collect all files of the given media resource type
     * 
     * @param type
     */
	...
	/**
	 * Creates collector that collects a max number of items of any type (files, folders, etc)
	 * 
	 * @param max
	 */
    ...
    public boolean visit(IMediaResource resource, IProgressMonitor mon) {
    	if (collectedSize>=max) return false;
