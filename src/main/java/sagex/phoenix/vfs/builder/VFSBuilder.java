...
public class VFSBuilder extends VFSManagerBuilder {
     ...
     *
     * @param vfsXML
     * @param vfsDir  - primary vfs dir that contains the vfs.dtd
     * @param manager
     * @throws ParserConfigurationException
     * @throws SAXException
     * @throws IOException
     */
    public static void registerVFSSources(File vfsXML, File vfsDir, VFSManager manager) throws ParserConfigurationException,
            SAXException, IOException {
        registerVFSSources(new FileInputStream(vfsXML), vfsDir, manager);
    }

    public static void registerVFSSources(String vfsXML, File vfsDir, VFSManager manager) throws ParserConfigurationException,
            SAXException, IOException {
        registerVFSSources(new ByteArrayInputStream(vfsXML.getBytes()), vfsDir, manager);
    }

    public static void registerVFSSources(InputStream xmlStream, File vfsDir, VFSManager manager)
