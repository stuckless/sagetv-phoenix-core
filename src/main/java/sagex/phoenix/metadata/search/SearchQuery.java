...
public class SearchQuery implements Serializable, HasHints {
    ...
    */
    public enum Field { QUERY, RAW_TITLE, CLEAN_TITLE, SEASON, EPISODE, DISC, EPISODE_TITLE, EPISODE_DATE, YEAR, FILE, URL, PROVIDER, ID, ARTIST, ALBUM};
	...
	public String toString() {
		return "SearchQuery [type=" + type + ", fields=" + mapToString(fields) + ", hints="
				+ hints + "]";
	}
