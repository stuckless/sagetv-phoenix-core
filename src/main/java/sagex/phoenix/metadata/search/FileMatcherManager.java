...
public class FileMatcherManager extends SystemConfigurationFileManager implements SystemConfigurationFileManager.ConfigurationFileVisitor {
    ...
    /**
     * Returns a new builder that can be used to build {@link FileMatcher} objects from Xml.
     * 
     * @param sourceFile
     * @return
     */
