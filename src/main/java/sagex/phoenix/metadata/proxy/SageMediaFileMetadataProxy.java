...
/**
 * metadata proxy that uses Set/GetMediaFileMetadata for storing/accessing
 * metadata.
 *
 * @author seans
 */
public class SageMediaFileMetadataProxy extends AbstractMetadataProxy {
    ...
    public static IMetadata newInstance(Object mediaFile) {
        return (IMetadata) java.lang.reflect.Proxy.newProxyInstance(SageMediaFileMetadataProxy.class.getClassLoader(),
                new Class[]{IMetadata.class}, new SageMediaFileMetadataProxy(mediaFile));
    }
}
