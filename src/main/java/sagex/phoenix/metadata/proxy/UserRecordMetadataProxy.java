...
public class UserRecordMetadataProxy extends AbstractMetadataProxy {
    ...
    public static IMetadata newInstance(String store, String id) {
        return (IMetadata) java.lang.reflect.Proxy.newProxyInstance(UserRecordMetadataProxy.class.getClassLoader(), new Class[] {IMetadata.class}, new UserRecordMetadataProxy(store, id));
    }
}
