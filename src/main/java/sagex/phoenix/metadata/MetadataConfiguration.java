...
//    @AField(label="Add Series Fanart for Failed TV Lookups", description="If enabled, it will add the TV Series Fanart for the TV item, even though an exact episode was not found")
//    private FieldProxy<Boolean> addFanartForIncompleteTV = new FieldProxy<Boolean>(false);
