...
public class MetadataHints {
	...
	/**
	 * Hint to indicate that you want to scan ONLY files that currently do not have metadata
	 * {@value}}
	 */
	public static final String SCAN_MISSING_METADATA_ONLY = "scan_missing_metadata";

	/**
	 * Hint to indicate that you want to scan subfolders
	 * {@value}
	 */
	...
	/**
	 * Hint to specify that this query is for a sage recording that SageTV is currently aware of.
	 * 
	 * {@value}
	 */
	...
	/**
	 * Hint to specify that this query originated from an automatic scan from the automatic plugin.
	 * {@value}
	 */
	...
	/**
	 * Hint to specify that you want to preserve the original recording metadata for a media item
	 * ie, only update the custom fields, and not the orginal metadata
	 */
