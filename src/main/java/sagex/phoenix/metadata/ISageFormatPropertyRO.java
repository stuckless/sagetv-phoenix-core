...
public interface ISageFormatPropertyRO extends ISageMetadata {
    ...
    // (where StreamNum < NumStreams and XXX is one of the Format.Audio.XXX
    // properties)
    ...
    // (where StreamNum < NumStreams and XXX is one of the Format.Subtitle.XXX
    // properties),
    ...
    @SageProperty("Format.Audio.Bitrate")
    // (in kbps),
    ...
    @SageProperty("Format.Video.Bitrate")
    // (in Mbps)
