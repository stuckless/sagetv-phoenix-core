...
public interface ISageCustomMetadataRW extends ISageMetadata {
    ...
    /**
     * UserRating should be a value between 0 and 100, so a rating of "9.5" would
     * actually be "95"
     * 
     * @return
     */
    ...
    /**
     * DefaultPoster, DefaultBackground, and DefaultBanner should ONLY set the relative
     * path of the poster, background, banner, relative to the CentralFanart dir.
     * 
     * @return
     */
