...
@AGroup(label = "TheMovieDB 3 Configuration", path = "phoenix/metadata/tmdb", description = "Configuration for The TheMovieDB")
public class TMDBConfiguration extends GroupProxy {
