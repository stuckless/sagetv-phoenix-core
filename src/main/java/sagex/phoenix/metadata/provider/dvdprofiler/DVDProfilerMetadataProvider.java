...
public class DVDProfilerMetadataProvider extends MetadataProvider {
    ...
    /**
     * searching is synchronized because of the potential to need to rebuild the index.
     */
    ...
    /**
     * getting metadata is synchronized because of the potention to rebuild the indexes
     */
