...
public interface IMetadataPersistence {
	 ...
	 * @param file {@link IMediaFile} that will be updated
	 * @param md {@link IMetadata} current metadata that needs to be stored
	 * @param options {@link Hints} options that may be used when storing
