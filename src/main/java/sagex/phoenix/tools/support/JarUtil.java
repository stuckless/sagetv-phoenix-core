...
public class JarUtil {
    ...
    /**
     * Can test if the first version is at least equal to or greater than the second version.
     * 
    ...
    public static boolean IsAtLeastVersion(String verToTest, String baseVersion) {
        if (verToTest==null || baseVersion==null) return false;
        if (verToTest.equals(baseVersion)) return true;
