...
public @interface AField {
    ...
    /**
     * provides a list as a string list "value:label,value1:label1". Can also
     * use an IOptionFactory class name like, "class:com.myname.MyOptionFactory"
     */
    String list() default "";

    /**
     * Used by a setter/getter to know how to separate list items when
     * getting/setting. Multiple characters can be specified, ie, ";,/", meaning
     * to split on either semi-colon or comma or slash. The first charactar will
    ...
    /**
     * Arbitrary hints. Most likely will be ignore, but can be consumed by UIs
     * to better handle how to render certain elements. Comma separate.
     *
     * @return
     */
    ...
    /**
     * Configuration Type, aligned with the Sage7 Configuration Types, as
     * defined in {@link ConfigType}
     */
