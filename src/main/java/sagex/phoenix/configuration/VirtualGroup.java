...
/**
 * A VirtualGroup is used to collate a group of items without reparenting the
 * items.
 * <p/>
 * ie, any items added to a virtual group will be visible to the group, but it
 * will remove the item from it's previous parent.
 * <p/>
