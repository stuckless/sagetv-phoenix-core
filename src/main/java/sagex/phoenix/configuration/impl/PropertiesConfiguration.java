...
/**
 * Simple file based, {@link Properties} based configuration provider that does not provide scoped
 * properties.  Server, Client, and User all share the same {@link Properties}
 * 
 * @author sean
 *
 */
