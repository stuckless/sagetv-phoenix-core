...
public class StaticOptionsFactory implements IOptionFactory, Iterable<NamedValue> {
	...
	/**
	 * Creates option list using a string in the format
	 * "value1:label1, value2:label2, value3:label3,..." alternately you can use
	...
	/**
	 * Creates an option list from an existing array of options. The option
	 * values can be in the form ["value1:label1","value2:label2",...]
	 * 
	 * @param optionString
	 */
