...
public class ConfigurationManager {
	/**
	 * event that is fired when a configuration element of type button is called with SetProperty()
	 * {@value}
	 */
    ...
    public String getProperty(String key, String defValue) {
    	...
    	if (ce!=null && ce instanceof Field) {
    		...
    		if (cs==null) cs = ConfigScope.CLIENT;
    ...
    /**
     * Set's a property using the defined scope.  If not scope, then client is used.
     * 
     * @param key
     * @param value
     * @return
...
//    	args.put(EVENT_PROPERTY, key);
//    	args.put(EVENT_VALUE, value);
//    	Phoenix.getInstance().getEventBus().fireEvent(SET_EVENT, args, false);
    }
    ...
    public void reload() {
    	// fire an event that configuration providers can listen for, to "reload".
