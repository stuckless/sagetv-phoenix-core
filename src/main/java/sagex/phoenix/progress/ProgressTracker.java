...
public class ProgressTracker<T> implements IProgressMonitor {
	...
	/**
	 * LinkedList is used as the return type because we want to access the list
	 * as a List and Queue, depending on the scenario.
	 * 
	 * @return
	 */
	...
	/**
	 * Sets a label for the tracker. A label is simply a name and has no other
	 * purpose
	 * 
	 * @param label
	 *            label to set
