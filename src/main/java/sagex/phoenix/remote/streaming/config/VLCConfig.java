...
public class VLCConfig extends GroupProxy {
    ...
    private FieldProxy<String> wifi_low = new FieldProxy<String>("#transcode{width=176,height=144,fps=15,vcodec=h264,vb=256,venc=x264{aud,profile=baseline,level=30,keyint=30,ref=1},acodec=mp3,ab=24,channels=2}:std{access=livehttp{seglen=5,delsegs=false,numsegs=0,index=${PMS_PLAYLIST_FILE},index-url=${PMS_BASE_URL}${PMS_MEDIA_ID}-########.ts},mux=ts{use-key-frames},dst=${PMS_OUTPUT_DIR}/${PMS_MEDIA_ID}-########.ts}");

    @AField(label="WIFI Normal Profile", description = "VLC Profile for Normal Detail over WIFI")
    private FieldProxy<String> wifi_normal = new FieldProxy<String>("#transcode{width=480,height=360,fps=25,vcodec=h264,vb=500,venc=x264{aud,profile=baseline,level=30,keyint=30,ref=1},acodec=mp3,ab=96,channels=2}:std{access=livehttp{seglen=5,delsegs=false,numsegs=0,index=${PMS_PLAYLIST_FILE},index-url=${PMS_BASE_URL}${PMS_MEDIA_ID}-########.ts},mux=ts{use-key-frames},dst=${PMS_OUTPUT_DIR}/${PMS_MEDIA_ID}-########.ts}");

    @AField(label="WIFI HD Profile", description = "VLC Profile for HD Detail over WIFI")
    private FieldProxy<String> wifi_hd = new FieldProxy<String>("#transcode{width=1280,height=720,fps=30,vcodec=h264,vb=1000,venc=x264{aud,profile=baseline,level=30,keyint=30,ref=1},acodec=mp3,ab=128,channels=2}:std{access=livehttp{seglen=5,delsegs=false,numsegs=0,index=${PMS_PLAYLIST_FILE},index-url=${PMS_BASE_URL}${PMS_MEDIA_ID}-########.ts},mux=ts{use-key-frames},dst=${PMS_OUTPUT_DIR}/${PMS_MEDIA_ID}-########.ts}");

    @AField(label="Mobile Low Profile", description = "VLC Profile for Low Detail over Mobile (3g)")
    private FieldProxy<String> mobile_low = new FieldProxy<String>("#transcode{width=176,height=144,fps=15,vcodec=h264,vb=256,venc=x264{aud,profile=baseline,level=30,keyint=30,ref=1},acodec=mp3,ab=24,channels=2}:std{access=livehttp{seglen=5,delsegs=false,numsegs=0,index=${PMS_PLAYLIST_FILE},index-url=${PMS_BASE_URL}${PMS_MEDIA_ID}-########.ts},mux=ts{use-key-frames},dst=${PMS_OUTPUT_DIR}/${PMS_MEDIA_ID}-########.ts}");

    @AField(label="Mobile Normal Profile", description = "VLC Profile for Normal Detail over Mobile (3g)")
    private FieldProxy<String> mobile_normal = new FieldProxy<String>("#transcode{width=480,height=360,fps=25,vcodec=h264,vb=256,venc=x264{aud,profile=baseline,level=30,keyint=30,ref=1},acodec=mp3,ab=96,channels=2}:std{access=livehttp{seglen=5,delsegs=false,numsegs=0,index=${PMS_PLAYLIST_FILE},index-url=${PMS_BASE_URL}${PMS_MEDIA_ID}-########.ts},mux=ts{use-key-frames},dst=${PMS_OUTPUT_DIR}/${PMS_MEDIA_ID}-########.ts}");

    @AField(label="Mobile HD Profile", description = "VLC Profile for HD Detail over Mobile (3g)")
    private FieldProxy<String> mobile_hd = new FieldProxy<String>("#transcode{width=1280,height=720,fps=25,vcodec=h264,vb=512,venc=x264{aud,profile=baseline,level=30,keyint=30,ref=1},acodec=mp3,ab=96,channels=2}:std{access=livehttp{seglen=5,delsegs=false,numsegs=0,index=${PMS_PLAYLIST_FILE},index-url=${PMS_BASE_URL}${PMS_MEDIA_ID}-########.ts},mux=ts{use-key-frames},dst=${PMS_OUTPUT_DIR}/${PMS_MEDIA_ID}-########.ts}");

    @AField(label="Default Profile", description = "VLC Profile when no other profile is found")
    private FieldProxy<String> default_profile = new FieldProxy<String>("#transcode{width=480,height=360,fps=25,vcodec=h264,vb=500,venc=x264{aud,profile=baseline,level=30,keyint=30,ref=1},acodec=mp3,ab=96,channels=2}:std{access=livehttp{seglen=5,delsegs=false,numsegs=0,index=${PMS_PLAYLIST_FILE},index-url=${PMS_BASE_URL}${PMS_MEDIA_ID}-########.ts},mux=ts{use-key-frames},dst=${PMS_OUTPUT_DIR}/${PMS_MEDIA_ID}-########.ts}");
