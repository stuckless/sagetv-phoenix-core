...
import sagex.remote.json.JSONTokener;
...
public class Sender {
   ...
   * @throws java.io.IOException if message could not be sent or received.
   */
  public MulticastResult sendNoRetry(Message message,
    ...
    String requestBody = toJSONString(jsonRequest);
...
private IOException newIoException(String responseBody, Exception e) {
  ...
  private Number getNumber(JSONObject jsonResponse, String field) {
    Object value = jsonResponse.opt(field);
    if (value == null) {
