...
public class AndroidDeviceRegistry {
	...
	public Device getDevice(String id) {
		...
		d.lastAccessed = NumberUtils.toLong(Configuration.GetServerProperty(key(id, LAST_ACCESS), null), System.currentTimeMillis());
		return d;
	}
	...
	String key(String key, String id) {
		// not unique... but, rare overlap, given the amount of devices we'll be seeing
	...
	public boolean sendMessage(Map<String,String> message, String... device) {
        ...
        // sender.sendNoRetry(m, "APA91bE2i3-9Iy2-3wAoa9hbq_aATgs-Dplukr0mrjF2QeYreMsBMQo7oLRFqaGBaQCQRU-qlLaPpGbDI3imENBow_0jDvJav8mUiqplAzlc4rKY6i8excz8XeTt1V3t5ZtZFzCUbPwnKaxviIeV6iQirN9xVsEPKXmQ_0BlzgTEt4uhZo3YL7U");
        try {
