...
public class SimpleEventBus implements IEventBus {
     ...
     * (non-Javadoc)
     *
     * @see sagex.phoenix.event.IEventBus#addListener(java.lang.String,
     * sage.SageTVEventListener)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see sagex.phoenix.event.IEventBus#fireEvent(java.lang.String,
     * java.util.Map)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see sagex.phoenix.event.IEventBus#removeListener(java.lang.String,
     * sage.SageTVEventListener)
     */
    @Override
