...
/**
 * FileMonitor is thread that monitors the size of a file until it reaches a certain size OR a 
 * period of time elapses.  An Handler is passed that is updated on the File's size.  The handler
 * is also notified when the monitor starts, updates, and completes.
 * 
 * FileMonitor can be used to monitor a File Download and act on the file after a certain amount of time
 * has passed or if the File's size has reached a certain size.
 * 
 * @author sean
 *
 */
