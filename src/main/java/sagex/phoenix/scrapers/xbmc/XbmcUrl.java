...
public class XbmcUrl {
    ...
    /**
     * Creates xbmc url from string. String can be just a simple url, or an xml
     * fragment <url>text</url>
     *
     * @param url
     */
    ...
    /**
     * Creates an XbmcUrl from a given xml url fragment, and stores a reference
     * from the scraper that created the url fragment. This is typically used
    ...
    public InputStream getInputStream() throws Exception {
        // check if this is a function lookup, and if so, then let's process
        // this as such.
