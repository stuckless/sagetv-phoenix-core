        ...
        try {
            if (os!=null) {
                ...
                if (sageos==null || !sageos.startsWith(os)) {
                    log.debug("Skipping Action: " + this + "; since the Sage OS: " + sageos + " doesn't match the required OS: " + os);
                    return true;
                }
            }
            ...
            if (getOutputVariable()!=null) {
                Object output = Utility.ExecuteProcessReturnOutput(UIContext.getCurrentContext(), action, getArgs(), workDir, true, true);
