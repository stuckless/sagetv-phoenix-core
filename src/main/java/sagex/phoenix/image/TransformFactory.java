...
public class TransformFactory {
    ...
    public IBufferedTransform createTransform(String jsonCmd) throws Exception {
        try {
            if (jsonCmd == null) throw new Exception("createTransform(): was passed null transformat command.");
    ...
    private IBufferedTransform createTransform(JSONObject jo) throws Exception {
        ...
        if ("scale".equals(name)) {
            ...
            bt = new GradientImageTransform(jo.getInt("width"), jo.getInt("height"), (float)jo.getDouble("opacityStart"), (float)jo.getDouble("opacityEnd"));
