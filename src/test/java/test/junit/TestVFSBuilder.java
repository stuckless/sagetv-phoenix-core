...
public class TestVFSBuilder {
    ...
    public void testTags() {
        ...
        // 5 tvs, (tv, archivedtv, all, and filesystem) + 3 dvds (but 2 are overlapping so 5 total)
    ...
    public void testSources() throws Exception {
        ...
        ViewFactory source = Phoenix.getInstance().getVFSManager().getVFSViewFactory().getFactory("phoenix.view.source.sagearchivedrecordings");
        ...
        ViewFactory viewfact = Phoenix.getInstance().getVFSManager().getVFSViewFactory().getFactory("phoenix.view.source.sagerecordings");
        ...
        //assertTrue("Folder does not have 'tv' tag, and it should.", phoenix.media.HasTag(view, "tv"));
        //assertTrue("Folder has 'music' tag and it should not.", !phoenix.api.HasTag(view, "music"));
    }
    ...
    public void testGroupDefaultFolderName() throws ParserConfigurationException, SAXException, IOException {
    	...
    	VFSBuilder.registerVFSSources(viewxml, Phoenix.getInstance().getVFSManager().getSystemFiles().getDir(), Phoenix.getInstance().getVFSManager());
    ...
    private void setResordings() {
    	...
    	api.addExpression("phoenix_util_ToArray(phoenix_util_RemoveAll(GetMediaFiles(\"T\"), GetMediaFiles(\"TL\")))", airings); // consider adding implementing expression with real return value
    ...
    public void testSaveViewState() throws IOException {
    	...
    	//assertEquals("desc", s.getOption(Sorter.OPT_SORT_ORDER).getString(null));
