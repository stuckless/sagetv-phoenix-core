...
public class TestUtilAPI {
    ...
    public void testRelativePath() {
        ...
        assertEquals("Movies/DVD/MyDvd.avi", api.GetRelativePath(new File[] {new File("/tmp/MyVideos"), new File("/tmp/Videos")}, mediaFile));
        assertEquals("Movies/DVD/MyDvd.avi", api.GetRelativePath(new File[] {new File("/tmp/MyVideos"), new File("/tmp/Videos")}, "/tmp/Videos/Movies/DVD/MyDvd.avi"));
    }
