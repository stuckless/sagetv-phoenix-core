...
public class TestMenus {
    ...
    public void testMenuBuilder() throws Throwable, SAXException, IOException {
        ...
        //System.out.println("VAL: " + phoenix.config.GetProperty("phoenix/debug/enableLogging") + "; Class: " + phoenix.config.GetProperty("phoenix/debug/enableLogging").getClass());
        ...
        //assertTrue("isVisibleOnPropery should be true", mi.isVisibleOnProperty());
    ...
    public void testMenuBuilderUsingPhoenixAPI() throws Throwable, SAXException, IOException {
        ...
        //phoenix.api.SetProperty("phoenix/debug/enableLogging", true);
        //assertTrue("isVisible should be true", phoenix.api.IsMenuItemVisible(mi));
    ...
    public void testFragments() throws IOException {
    	...
    	SageAPI.setProvider(api);
        FileUtils.copyFileToDirectory(TestMenusFile, new File("target/testing/STVs/Phoenix/Menus"));
        FileUtils.copyFileToDirectory(new File(TestMenusFile.getParentFile(), "Fragments.xml"), new File("target/testing/STVs/Phoenix/Menus"));
        Phoenix.getInstance().getMenuManager().loadConfigurations();
