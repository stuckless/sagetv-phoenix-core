...
public class TestDynamicVariables {
    ...
    public void testDYNAMIC_OtherVariables() {
    	...
    	assertEquals(ScopedConfigurationPropertyVariable.Scope.Client, ((ScopedConfigurationPropertyVariable)d1.getVariable()).getScope());
    	...
    	assertTrue(d1.getVariable() instanceof ScopedConfigurationPropertyVariable);
    	assertEquals(ScopedConfigurationPropertyVariable.Scope.User, ((ScopedConfigurationPropertyVariable)d1.getVariable()).getScope());
    	assertEquals("var/test2", ((ScopedConfigurationPropertyVariable)d1.getVariable()).getKey());

    	d1.setValue("prop:server:var/test3");
    	assertTrue(d1.getVariable() instanceof ScopedConfigurationPropertyVariable);
    	assertEquals(ScopedConfigurationPropertyVariable.Scope.Server, ((ScopedConfigurationPropertyVariable)d1.getVariable()).getScope());
