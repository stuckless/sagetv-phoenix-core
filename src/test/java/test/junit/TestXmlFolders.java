...
public class TestXmlFolders {
    ...
    public void testRSSFeed() {
    	...
    	assertEquals("http://trailers.apple.com/trailers/weinstein/theartist/", ((IMediaFile)f.getChildren().get(0)).getMetadata().getMediaUrl());
    }
    ...
    public void testAtomFeed() {
    	...
    	assertEquals("http://a1151.v.phobos.apple.com/us/r1000/080/Video/eb/27/f3/mzm.xcbhexre..640x458.h264lc.d2.p.m4v", ((IMediaFile)f.getChildren().get(0)).getMetadata().getMediaUrl());
    }
    ...
    public void testItunesRSSViaXmlFactory() {
    	...
    	assertEquals("RISE OF THE PLANET OF THE APES is a revolution; an action-packed epic featuring stunning visual effects and creatures unlike anything ever seen before. At the story's heart is Caesar (Andy Serkis), a chimpanzee who gains human-like intelligence and emotions from an experimental drug. Raised like a child by the drug's creator (James Franco), Caesar ultimately finds himself taken from the humans he loves and imprisoned. Seeking justice, Caesar assembles a simian army and escapes -- putting man and primate on a collision course that could change the planet forever.", ((IMediaFile)f.getChildren().get(0)).getMetadata().getDescription());
    }
