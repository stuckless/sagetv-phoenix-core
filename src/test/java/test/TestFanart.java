...
public class TestFanart {
    public static void main(String args[]) {
        IFanartSupport supports[] = new IFanartSupport[] {
                new SageMCFanartSupport(),
                new PhoenixFanartSupport(),
                new LocalFanartSupport()
        };
        
        for (IFanartSupport support : supports) {
            System.out.println("BeginTesting: " + support.getClass().getName());
            testFolder(support, new File("Terminator.avi"), MediaType.MOVIE, MediaArtifactType.BACKGROUND, "Terminator?", "/centralFanart");
            testFolder(support, new File("Terminator.avi"), MediaType.MOVIE, MediaArtifactType.POSTER, "Terminator?", "/centralFanart");
            testFolder(support, new File("Terminator.avi"), MediaType.MOVIE, MediaArtifactType.BANNER, "Terminator?", "/centralFanart");
            System.out.println("---");
            testFolder(support, new File("Terminator.avi"), MediaType.TV, MediaArtifactType.BACKGROUND, "Terminator?", "/centralFanart");
            ...
            System.out.println("---");
            testFolder(support, new File("Terminator.avi"), MediaType.MUSIC, MediaArtifactType.BACKGROUND, "Terminator?", "/centralFanart");
            testFolder(support, new File("Terminator.avi"), MediaType.MUSIC, MediaArtifactType.POSTER, "Terminator?", "/centralFanart");
            testFolder(support, new File("Terminator.avi"), MediaType.MUSIC, MediaArtifactType.BANNER, "Terminator?", "/centralFanart");
            System.out.println("---");
        ...
        //f.SetFanartArtifactForTitleWithFile(new File("target/testfile.avi"), new File("target/MyFile.jpg"), MediaType.MOVIE, MediaArtifactType.BACKGROUND, "OhYeah", "target");
    ...
    private static void dumpFanartPath(MediaType mediaType, MediaArtifactType artifactType, String title, String centralFolder, Map<String, String> metadata) {
    ...
    private static void testFolder(IFanartSupport support, File file, MediaType mediaType, MediaArtifactType artifactType, String title, String centralFanart) {
        System.out.println("");
