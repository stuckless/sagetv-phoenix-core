...
public class MediaStreamerManagerTest {
	...
	public void testVLCStream() throws InterruptedException {
		...
		req.setBaseUrl("http://192.168.1.12/test123/"); // clientid should be in
														// the base url
	...
	public void testGenericCommandStream() throws InterruptedException {
		Phoenix.getInstance().getMediaStreamer().getConfig().getScriptConfig()
				.setCommand("/home/sls/SparkleShare/PHOENIX/Phoenix/src/main/STVs/Phoenix/streaming/vlcstream.sh");
		MediaRequest req = new MediaRequest();
